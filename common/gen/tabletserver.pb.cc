...
const ::google::protobuf::Descriptor* TabletInfo_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  TabletInfo_reflection_ = NULL;
...
void protobuf_AssignDesc_tabletserver_2eproto() {
  ...
  static const int TabletDescription_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TabletDescription, size_),
  };
  ...
  static const int TabletInfo_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TabletInfo, must_cross_dims_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TabletInfo, must_cross_vals_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TabletInfo, status_),
  };
  TabletInfo_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      TabletInfo_descriptor_,
      TabletInfo::default_instance_,
      TabletInfo_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TabletInfo, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TabletInfo, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(TabletInfo));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    TabletInfo_descriptor_, &TabletInfo::default_instance());
}
...
void protobuf_ShutdownFile_tabletserver_2eproto() {
  ...
  delete TabletInfo::default_instance_;
  delete TabletInfo_reflection_;
}
...
void protobuf_AddDesc_tabletserver_2eproto() {
  ...
  TabletInfo::default_instance_ = new TabletInfo();
  ...
  TabletInfo::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int RemoveRequest::kTabletFieldNumber;
...
void RemoveRequest::InitAsDefaultInstance() {
  key_ = const_cast< ::Box*>(&::Box::default_instance());
}
...
void RemoveRequest::MergeFrom(const RemoveRequest& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_key()) {
      mutable_key()->::Box::MergeFrom(from.key());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
const int TabletDescription::kSizeFieldNumber;
#endif  // !_MSC_VER
...
#ifndef _MSC_VER
const int TabletInfo::kServerFieldNumber;
const int TabletInfo::kNameFieldNumber;
const int TabletInfo::kMustCrossDimsFieldNumber;
const int TabletInfo::kMustCrossValsFieldNumber;
const int TabletInfo::kStatusFieldNumber;
#endif  // !_MSC_VER
...
void TabletInfo::InitAsDefaultInstance() {
  status_ = const_cast< ::Status*>(&::Status::default_instance());
}

TabletInfo::TabletInfo(const TabletInfo& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void TabletInfo::SharedCtor() {
  _cached_size_ = 0;
...
void TabletInfo::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* TabletInfo::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return TabletInfo_descriptor_;
}

const TabletInfo& TabletInfo::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_tabletserver_2eproto();
  return *default_instance_;
}

TabletInfo* TabletInfo::default_instance_ = NULL;

TabletInfo* TabletInfo::New() const {
  return new TabletInfo;
}

void TabletInfo::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (has_server()) {
      if (server_ != &::google::protobuf::internal::kEmptyString) {
        server_->clear();
...
bool TabletInfo::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_must_cross_dims;
        break;
      }
      ...
      case 3: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_must_cross_dims:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 24, input, this->mutable_must_cross_dims())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, this->mutable_must_cross_dims())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(24)) goto parse_must_cross_dims;
        if (input->ExpectTag(33)) goto parse_must_cross_vals;
        break;
      }
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_FIXED64) {
         parse_must_cross_vals:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   double, ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE>(
                 1, 33, input, this->mutable_must_cross_vals())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
                   double, ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE>(
                 input, this->mutable_must_cross_vals())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(33)) goto parse_must_cross_vals;
...
void TabletInfo::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required string server = 1;
  if (has_server()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
  ...
  // repeated int32 must_cross_dims = 3;
  for (int i = 0; i < this->must_cross_dims_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
      3, this->must_cross_dims(i), output);
  }

  // repeated double must_cross_vals = 4;
  for (int i = 0; i < this->must_cross_vals_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(
      4, this->must_cross_vals(i), output);
  }
...
::google::protobuf::uint8* TabletInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // required string server = 1;
  if (has_server()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
  ...
  for (int i = 0; i < this->must_cross_dims_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(3, this->must_cross_dims(i), target);
  }

  // repeated double must_cross_vals = 4;
  for (int i = 0; i < this->must_cross_vals_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteDoubleToArray(4, this->must_cross_vals(i), target);
  }
  ...
  // repeated int32 must_cross_dims = 3;
  {
    ...
    for (int i = 0; i < this->must_cross_dims_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->must_cross_dims(i));
    }
    total_size += 1 * this->must_cross_dims_size() + data_size;
  }

  // repeated double must_cross_vals = 4;
  {
    int data_size = 0;
    data_size = 8 * this->must_cross_vals_size();
    total_size += 1 * this->must_cross_vals_size() + data_size;
  }
...
void TabletInfo::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const TabletInfo* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const TabletInfo*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void TabletInfo::MergeFrom(const TabletInfo& from) {
  GOOGLE_CHECK_NE(&from, this);
  must_cross_dims_.MergeFrom(from.must_cross_dims_);
  must_cross_vals_.MergeFrom(from.must_cross_vals_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_server()) {
...
void TabletInfo::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void TabletInfo::CopyFrom(const TabletInfo& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool TabletInfo::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;
...
void TabletInfo::Swap(TabletInfo* other) {
  if (other != this) {
    std::swap(server_, other->server_);
    std::swap(name_, other->name_);
    must_cross_dims_.Swap(&other->must_cross_dims_);
    must_cross_vals_.Swap(&other->must_cross_vals_);
    std::swap(status_, other->status_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
...
::google::protobuf::Metadata TabletInfo::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = TabletInfo_descriptor_;
  metadata.reflection = TabletInfo_reflection_;
  return metadata;
}
